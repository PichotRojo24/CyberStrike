...
export class RightLoseSceneMultiplayer extends Phaser.Scene {
    constructor() {
        super('RightLoseSceneMultiplayer');
    }

    preload() {
        this.load.image('RightLoseMultiplayer', 'assets/Pantallas/Derrota Jug2.png');
    ...
    create() {
        this.add.image(400, 300, 'RightLoseMultiplayer')
            .setOrigin(0.5, 0.5)
