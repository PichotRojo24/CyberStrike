...
export class LeftWinSceneMultiplayer extends Phaser.Scene {
    constructor() {
        super('LeftWinSceneMultiplayer');
    }

        preload() {
        this.load.image('LeftWinMultiplayer', 'assets/Pantallas/Victoria Jug1.png');
    ...
    create() {
        this.add.image(400, 300, 'LeftWinMultiplayer')
                .setOrigin(0.5, 0.5)
