...
export class LeftLoseSceneMultiplayer extends Phaser.Scene {
    constructor() {
        super('LeftLoseSceneMultiplayer');
    }

    preload() {
        this.load.image('LeftLoseMultiplayer', 'assets/Pantallas/Derrota Jug1.png');
    ...
    create() {
        this.add.image(400, 300, 'LeftLoseMultiplayer')
            .setOrigin(0.5, 0.5)
